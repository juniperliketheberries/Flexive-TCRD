...
function template_main()
{
	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if (!empty($board['children']))
			{
				...
				echo '
						<p id="board_', $board['id'], '_children">
	...
	<div class="tborder topic_table" id="messageindex">
		...
		{
			echo '
					<th scope="col" class="first_th th-icon hidden-xs-maybe" style="width: 8%" colspan="2">&nbsp;</th>
					<th scope="col" class="lefttext th-subject"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['subject'], $context['sort_by'] == 'subject' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
					<th scope="col" style="width:14%" class="centertext th-stats hidden-xs-maybe"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=replies', $context['sort_by'] == 'replies' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['replies'], $context['sort_by'] == 'replies' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', $context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['views'], $context['sort_by'] == 'views' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			// Show a "select all" box for quick moderation?
			if (empty($context['can_quick_mod']))
				echo '
					<th scope="col" class="lefttext last_th" style="width:22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			else
				echo '
					<th scope="col" class="lefttext" style="width:22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
		...
		foreach ($context['topics'] as $topic)
		{
			if (!empty($settings['st_separate_sticky_locked']))
			{
				if ($topic['is_sticky'] && !$stickybar)
				{
					echo '
					<tr class="titlebg">
						<td colspan="', empty($options['display_quick_mod']) ? '5' : '6', '">
							<strong>', $txt['st_sticky_topic'], '</strong>
						</td>
					</tr>';
					$stickybar = true;
				}
				elseif (!$topic['is_sticky'] && $stickybar && !$normalbar)
				{
					...
					<tr class="catbg">
						<td colspan="', empty($options['display_quick_mod']) ? '5' : '6', '">
							<strong>', $txt['st_normal_topic'], '</strong>
						</td>
					</tr>';
					$normalbar = true;
				}
			...
			{
				echo '
					<td class="moderation ', $color_class, ' text-center">';
